...
![Текст программы](image/1-2.png){#fig:1-2 width=70%}

23. Создал исполняемый файл.{@fig:1-3 width=70%}

![Трансляция и компановка](image/1-3.png){#fig:1-3 width=70%}

24. Запустил исполняемый файл и ввёл первое значение x.{@fig:1-4 width=70%}

![Результат работы программы](image/1-4.png){#fig:1-4 width=70%}

25. Запустил исполняемый файл и ввёл второе значение x.{@fig:1-5 width=70%}

![Результат работы программы](image/1-5.png){#fig:1-5 width=70%}
...
#2. Для считывания сообщения.

#3. Для преобразования ascii-код символа в целое число.
...
#6. Для прибавления к единицы к значению лежащему в edx.
...
В этой работе были освоены арифметические инструкции языка ассемблера NASM.
